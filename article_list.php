				...
				<section class="all_aricles">
					<header>
						...
						<h1 class="mb-4"><?php if(isset($currentCategory)): ?><?php echo $currentCategory['name']; ?><?php else : ?>Tous les articles<?php endif; ?> :</h1>
							<img src="img/category/<?php echo $currentCategory['image']; ?>	" alt="">
					...
					<?php if(!empty($articles)): ?>
						...
						<div class="row">
							<div class="col-1"style="margin-left: 20px; background-image: url(img/article/<?php echo $article['image'] ?>); background-size: cover;">
							</div>
							<div class="col-10">
								<article class="mb-4">
